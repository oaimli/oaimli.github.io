...
In the long term, Miao's overarching research goal is to (1) explore the potential for machines to achieve superhuman-level reasoning and consolidation over multiple heterogeneous documents with voluminous and complex information and realize human-like communication conveying information based on devised consequences from them, and (2) develop high-quality evaluations of artificial intelligence systems on these complex language generation tasks. 
