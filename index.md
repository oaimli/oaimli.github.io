...
- Rational evaluation of large language models (LLMs) based on language-related theories;
- Evaluation metrics for natural language generation, particularly for text summarization;
