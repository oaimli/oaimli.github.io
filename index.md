...
My research interests are centred around large-scale knowledge reasoning over lengthy or multiple documents for content-based natural language generation. Intelligent machines are expected to output high-quality natural language texts in alignment with human intents based on their comprehensive understanding of substantial amounts of information and accurate reasoning over intricate semantics in the input documents. This should be a fundamental capability of the expected artificial intelligence which enables human beings to obtain knowledge in natural language format from massive documents effortlessly. 
