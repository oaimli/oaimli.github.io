...
Throughout the years of pursuing the PhD degree, Miao's primary area of interest revolves around multi-document language processing. While multi-document summarization has achieved significant progress and large language models have demonstrated the capability to generate plausible summaries, the effectiveness of consolidating information from multiple documents remains uncertain. Miao's PhD research aims to investigate multi-document summarization from the perspective of information consolidation and make multi-document summarization less opaque and more grounded. In the long term, Miao's research goal is to explore the potential for natural language generation systems to achieve human-level information consolidation over extensive and various parallel sources composed of not only texts but also tables, charts, images or other multimedia elements, and realize human-like communication.
